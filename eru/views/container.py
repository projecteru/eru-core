...
container = Blueprint('container', __name__, url_prefix='/api/container')


@container.route('/<cid>/kill', methods=['PUT', ])
@jsonify
...
@container.route('/<cid>/poll', methods=['GET', ])
@jsonify
